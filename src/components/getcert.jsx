...
class Getcert extends Component {
  ...
  getcertificate = event => {
    ...
    const url = "https://ipfs.io/ipfs/" + this.state.id;
    window.open(url);
    console.log(url);
  ...
  gettransaction = event => {
    event.preventDefault();
    const url = "https://rinkeby.etherscan.io/tx/" + this.state.txh;
    window.open(url);
    console.log(url);
  };
          ...
          >
            <Form.Group>
              <Form.Control
                ...
                placeholder="Enter Ipfs Hash provided on the certificate"
              />
            </Form.Group>
            <Button
